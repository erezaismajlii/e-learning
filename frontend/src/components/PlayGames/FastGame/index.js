        ...
        <>
          <div>
            <div className="english-game-title">
              ...
              <h1>
                <span>Hands are faster than brains</span>
                <TooltipCustom
                  className="ml-5 cur-pointer"
                  title={`Choose the picture that matches the meaning of the word. Choosing the wrong -${WRONG_SCORE}đ, correct +${CORRECT_SCORE}đ. Points will be added to your remaining time.`}
                >
                  <HelpIcon />
                </TooltipCustom>
              </h1>
